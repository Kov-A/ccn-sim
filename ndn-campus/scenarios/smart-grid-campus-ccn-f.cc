...
int main (int argc, char *argv[])
{
	...
	std::cout << "  Getinng odNodes" << std::endl; 
	 ...
	 Ptr <Node> node1 = global.Get(1231);
	 Ptr <Node> node2 = global.Get(724);

	 Ptr <Node> node3 = global.Get(14);
     Ptr <Node> node4 = global.Get(15);
	/*
	...
	*/
	...
	// Consumer2
		...
		std::cout <<"odNodes->Get(0)->Get()" << std::endl;
	...
	Simulator::Schedule (Seconds (5.0), ndn::LinkControlHelper::FailLink, node1,node2);
    Simulator::Schedule (Seconds (10.0), ndn::LinkControlHelper::UpLink, node1,node2);

    Simulator::Schedule (Seconds (5.0), ndn::LinkControlHelper::FailLink, node3,node4);
    Simulator::Schedule (Seconds (10.0), ndn::LinkControlHelper::UpLink, node3,node4);
