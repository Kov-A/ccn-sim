...
///      NetDeviceContainer ndc3LAN[5][nLANClients];
  ...
  for (int z = 0; z < nCN; ++z) 
    {
      ...
      // link failure
     // Simulator::Schedule (Seconds (2.0), ndn::LinkControlHelper::FailLink,nodes_net2[1][0].Get(0),nodes_net2[1][1].Get(0));
     // Simulator::Schedule (Seconds (6.0), ndn::LinkControlHelper::UpLink,nodes_net2[1][0].Get(0), nodes_net2[1][1].Get(0));
      // Subnet 3 LANs
 ...
 Ptr <Node> node1 = global.Get(272);
 Ptr <Node> node2 = global.Get(9);
 ...
 // Simulator::Schedule (Seconds (2.0), ndn::LinkControlHelper::FailLink, node1,node2);
 // Simulator::Schedule (Seconds (6.0), ndn::LinkControlHelper::UpLink, node1,node2);
